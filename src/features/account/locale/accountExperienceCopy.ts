export const accountExperienceCopyV1 = {
  zh: {
    ...
    unavailableBody: "这不会影响 Doge 的任何本地功能。你可以稍后再试。",
    retry: "重试",
    retrying: "正在重试",
    retryAgain: "再次重试",
    ...
    credentialsRejectedFailure: "邮箱或密码不正确。",
    rateLimitedFailure: "操作太频繁，请稍后重试。",
    serviceUnavailableFailure: "账号服务暂时不可用，请稍后重试。",
    vaultUnavailableFailure: "系统凭据库暂时不可用，请解锁后重试。",
    protocolMismatchFailure: "账号服务响应异常，请稍后重试。",
    diagnosticCode: "诊断代码",
  ...
  en: {
    ...
    unavailableBody: "Every local Doge feature remains available. Try again later.",
    retry: "Retry",
    retrying: "Retrying",
    ...
    credentialsRejectedFailure: "The email or password is incorrect.",
    rateLimitedFailure: "Too many attempts. Try again later.",
    serviceUnavailableFailure: "The account service is temporarily unavailable. Try again later.",
    vaultUnavailableFailure: "The system credential vault is unavailable. Unlock it and try again.",
    protocolMismatchFailure: "The account service returned an unexpected response. Try again later.",
