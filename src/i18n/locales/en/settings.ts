...
const settings = {
  settings: {
    ...
    sidebarProviders: "Engine Management",
    ...
    sidebarVendors: "Engine Management",
    ...
    vendorsTitle: "Engine Management",
    vendorsDescription: "Manage engines, providers, and local settings.",
    vendor: {
    ...
    basicEmailTab: "Email",
    basicWechatTab: "WeChat",
    wechatTitle: "WeChat channel",
    wechatDescription: "Doge starts the bundled Tencent Weixin iLink bridge automatically for your WeChat account.",
    wechatEnableTitle: "Enable WeChat channel",
    wechatEnableDescription: "Enabling starts the bridge automatically. Private text messages and completed replies are routed through it.",
    wechatManagedDescription: "Doge manages the bridge, local secrets, and Tencent iLink provider; each WeChat contact selects an independent conversation target.",
    wechatBridgeUrl: "Bridge URL",
    wechatApiKey: "Bridge apiKey",
    wechatApiKeyPlaceholder: "Enter the bridge apiKey",
    wechatWebhookToken: "Webhook token",
    wechatWebhookTokenPlaceholder: "Enter a shared webhook token",
    wechatWebhookHost: "Webhook host",
    wechatWebhookPort: "Webhook port",
    wechatWebhookPath: "Webhook path",
    wechatDeviceType: "Device type",
    wechatSecretConfigured: "Secret is configured; leave blank to keep it",
    wechatStatusLoading: "Loading WeChat status...",
    wechatStatusUnconfigured: "Not configured",
    wechatStatusLoggedOut: "Not logged in",
    wechatStatusAwaitingConfirmation: "Waiting for confirmation",
    wechatStatusNeedVerification: "Verification code required",
    wechatStatusLoggedIn: "Logged in",
    wechatStatusDisconnected: "Disconnected",
    wechatStatusError: "Error",
    wechatRiskTitle: "Connect WeChat with Tencent iLink",
    wechatRiskBody: "WeChat authorizes this channel by scanning a Tencent Weixin iLink QR code. Messages are exchanged through Tencent iLink and this Doge installation; the login token is stored only in the local provider data directory.",
    wechatRiskConfirm: "Continue",
    wechatRiskHint: "Tencent Weixin iLink handles WeChat authorization; channel credentials remain in Doge's local provider data directory.",
    wechatSaved: "WeChat channel settings saved.",
    wechatSaving: "Saving...",
    wechatTestConnection: "Test connection",
    wechatRefreshQr: "Refresh QR code",
    wechatQrUpdated: "QR code refreshed.",
    wechatQrAlt: "WeChat login QR code",
    wechatVerifyLabel: "Verification code",
    wechatVerifyPlaceholder: "Digits shown in WeChat",
    wechatVerifyDescription: "Enter the digits displayed by WeChat on your phone to continue this login.",
    wechatVerifySubmit: "Verify",
    wechatVerifySubmitting: "Verifying...",
    wechatVerifySubmitted: "Verification code submitted. Confirm the login in WeChat if prompted.",
    wechatClearSecrets: "Clear secrets",
