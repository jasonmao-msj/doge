const zhPart1 = {
  ...
  pluginsPage: {
    title: "插件",
    subtitle: "从 GitHub 安装开源插件，扩展应用能力",
    installedSection: "已安装",
    officialSection: "官方插件",
    install: "安装",
    installing: "安装中…",
    installedBadge: "已安装",
    uninstall: "卸载",
    uninstalling: "卸载中…",
    openRepository: "查看仓库",
    customInstallTitle: "安装自定义插件",
    customInstallPlaceholder: "GitHub 仓库地址或本地目录绝对路径",
    customInstallHint: "插件仓库根目录必须包含 plugin.json",
    installSuccess: "插件安装成功",
    installFailed: "插件安装失败",
    uninstallSuccess: "插件已卸载",
    uninstallFailed: "插件卸载失败",
    emptyInstalled: "还没有安装任何插件",
    skillBadge: "技能",
    viewerBadge: "预览",
    glossaryBadge: "名词解释",
    glossarySource: "来自插件：{{plugin}}",
    skillLinked: "技能已接入",
    skillNotLinked: "技能未接入",
    versionLabel: "版本 {{version}}",
    composerButtonTitle: "插件",
    composerInstalledCount: "{{count}} 个已安装插件",
    composerEmpty: "还没有安装插件",
    composerManage: "管理插件…",
    previewButton: "预览",
    previewTitle: "插件预览",
    previewTriggerLabel: "触发器：{{plugin}} · {{pattern}}",
    copyHtml: "复制 HTML",
    copied: "已复制",
    previewLoadFailed: "加载文件失败",
  },
};
