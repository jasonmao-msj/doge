...
const settings = {
  settings: {
    ...
    vendorsTitle: "引擎管理",
    vendorsDescription: "管理引擎、供应商与本地设置",
    vendor: {
      officialConfig: "官方配置",
    ...
    basicWechatTab: "微信渠道",
    wechatTitle: "微信渠道",
    wechatDescription: "Doge 会自动启动内置 Tencent Weixin iLink bridge，连接微信账号。",
    wechatEnableTitle: "启用微信渠道",
    wechatEnableDescription: "开启后自动启动 bridge；bridge 接收私聊文本消息，并将回复发送回微信。",
    wechatManagedDescription: "bridge、本地密钥和 Tencent iLink provider 均由 Doge 自动管理；每位微信联系人独立选择会话目标。",
    wechatBridgeUrl: "Bridge 地址",
    wechatApiKey: "Bridge apiKey",
    wechatApiKeyPlaceholder: "输入 bridge apiKey",
    wechatWebhookToken: "Webhook token",
    wechatWebhookTokenPlaceholder: "输入共享 webhook token",
    wechatWebhookHost: "Webhook 主机",
    wechatWebhookPort: "Webhook 端口",
    wechatWebhookPath: "Webhook 路径",
    wechatDeviceType: "设备类型",
    wechatSecretConfigured: "密钥已配置；留空表示保持不变",
    wechatStatusLoading: "正在读取微信状态...",
    wechatStatusUnconfigured: "未配置",
    wechatStatusLoggedOut: "未登录",
    wechatStatusAwaitingConfirmation: "等待确认",
    wechatStatusNeedVerification: "需要数字验证码",
    wechatStatusLoggedIn: "已登录",
    wechatStatusDisconnected: "已掉线",
    wechatStatusError: "错误",
    wechatRiskTitle: "通过 Tencent iLink 连接微信",
    wechatRiskBody: "微信通过 Tencent Weixin iLink 二维码授权此渠道。消息经 Tencent iLink 与本机 Doge 处理；登录 token 仅保存在本机 provider data directory。",
    wechatRiskConfirm: "继续",
    wechatRiskHint: "微信授权由 Tencent Weixin iLink 提供；渠道凭据仅保存在 Doge 本机 provider data directory。",
    wechatSaved: "微信渠道设置已保存。",
    wechatSaving: "保存中...",
    wechatTestConnection: "测试连接",
    wechatRefreshQr: "刷新二维码",
    wechatQrUpdated: "二维码已刷新。",
    wechatQrAlt: "微信登录二维码",
    wechatVerifyLabel: "数字验证码",
    wechatVerifyPlaceholder: "输入手机微信显示的数字",
    wechatVerifyDescription: "输入手机微信显示的数字以继续本次登录。",
    wechatVerifySubmit: "提交验证",
    wechatVerifySubmitting: "验证中...",
    wechatVerifySubmitted: "验证码已提交；如手机微信继续提示，请确认登录。",
    wechatClearSecrets: "清除密钥",
