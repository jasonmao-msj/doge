const enPart1 = {
  ...
  pluginsPage: {
    title: "Plugins",
    subtitle: "Install open-source plugins from GitHub to extend the app",
    installedSection: "Installed",
    officialSection: "Official Plugins",
    install: "Install",
    ...
    customInstallTitle: "Install Custom Plugin",
    customInstallPlaceholder: "GitHub repository URL or absolute local folder path",
    customInstallHint: "The plugin repository root must contain plugin.json",
    ...
    glossarySource: "From plugin: {{plugin}}",
    skillLinked: "Skill linked",
    skillNotLinked: "Skill not linked",
    versionLabel: "Version {{version}}",
    composerButtonTitle: "Plugins",
    composerInstalledCount: "{{count}} installed plugins",
    composerEmpty: "No plugins installed",
    composerManage: "Manage plugins…",
    previewButton: "Preview",
    previewTitle: "Plugin Preview",
    previewTriggerLabel: "Trigger: {{plugin}} · {{pattern}}",
    copyHtml: "Copy HTML",
    copied: "Copied",
    previewLoadFailed: "Failed to load file",
  },
};
