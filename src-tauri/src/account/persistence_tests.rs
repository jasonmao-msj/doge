...
#[test]
fn engine_checkout_checkpoint_survives_restart_without_payment_action_data() {
    let repository = temporary_repository();
    let path = repository.path().to_path_buf();
    let record = EngineCheckoutRecord {
        authority_origin_id: "authority_token-matrix-production-v1".to_string(),
        account_link_id: "link_0123456789abcdef0123456789abcdef".to_string(),
        device_id: "device_0123456789abcdef0123456789abcdef".to_string(),
