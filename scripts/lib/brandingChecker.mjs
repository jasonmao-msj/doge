...
export const DEFAULT_ALLOWLIST = [
  ...
  compatibility(/^src\/features\/shared-session\/presentation\/sharedProjection\/dataSource\.ts$/, /mossx/i, "Reads the previous shared projection key and environment override."),
  ...
  compatibility(/^src\/conversation-presentation\/multi-agent\/(?:collabPrompt|canvasItems)\.ts$/, /mossx/, "Hides persisted collaboration control markers from older sessions."),
  ...
  compatibility(/^src\/conversation-presentation\/realtimePerfFlags\.ts$/, /CCGUI/, "Documents the historical backend event-batch environment flag."),
